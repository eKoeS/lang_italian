<?php
	...
	$dictionary = array(
		...
		'Il campo “{$title}” ({$type}) è stato rimosso.',
		...
		'Sorgente dati aggiornata %s.',

		'Create another?' =>
		'Crea nuovo',

		'View all Data sources' =>
		'Visualizza tutte le sorgenti dati',

		'Data source created at %s.' =>
		'Sorgente dati creata %s',

		'From extensions' =>
		'Estensioni',

		'Use %s syntax to filter by page parameters.' =>
		'La sintassi %s consente di usare i Parametri URL di una pagina per filtrare le voci.',
		...
		'La sintassi %s consente di usare i Parametri URL di una pagina per limitare il numero di voci.',

		'%1$s Paginate results, limiting to %2$s entries per page. Return page %3$s' =>
		'%1$s Dividi i risultati in pagine di %2$s voci ciascuna, a partire dalla pagina %3$s',

		'An empty result will be returned when this parameter does not have a value.' =>
		'Se il parametro non ha alcun valore, non verr&#224; restituito alcun risultato.',
		...
		'La sintassi %s consente di specificare porzioni dinamiche dell\'URL',
		...
		'%1$s released on %2$s' =>
		'%1$s rilasciato il %2$s',

		'Created by %1$s at %2$s' =>
		'Creato da %1$s il %2$s',

		'Failed to delete %s.' =>
		'Non è stato possibile rimuovere %s.',

		'Please check permissions on %s.' =>
		'Controlla i permessi in %s.',

		'Please ensure name contains at least one Latin-based character.' =>
		'Assicurati che il nome contenga almeno un carattere di famiglia latina.',

		'A Data source with the name %s already exists' =>
		'Una sorgente dati chiamata %s &#232; gi&#224; stata definita',

		'Failed to write Data source to disk.' =>
		'Non &#232; stato possibile scrivere la sorgente dati sul disco.',

		'Invalid URL' =>
		'URL non valido',

		'Request timed out. %d second limit reached.' =>
		'La richiesta è scaduta poiché ha richiesto più di %d secondi per terminare.',

		'Failed to load URL, status code %d was returned.' =>
		'Non è stato possibile caricare l\'URL desiderato (errore %d).',
		...
		'Un evento chiamato %s è già stato definito',

		'Notice that it is possible to get mixtures of success and failure messages when using the ‘Allow Multiple’ option' =>
		'N.B. &#232; possibile che utilizzando l\'opzione "Consenti l\'invio di pi&#249; voci" si possano ottenere sia messaggi di conferma che messaggi d\'errore',
		...
		'L\'azione relativa all\'invio di e-mail prende in input i dati inseriti nel form inviandoli al destinatario designato.',

		'It currently does not work with ‘Allow Multiple’' =>
		'Questa azione non &#232; compatibile con l\'opzione "Consenti l\'invio di pi&#249; voci',

		'The following are the recognised fields:' =>
		'Di seguito i campi riconosciuti:',

		'Failed to write Event to disk.' =>
		'Non è stato possibile scrivere l\'evento sul disco.',
		...
		'Il documento non &#232; ben formato.',

		'The following error was returned:' =>
		'L\'errore individuato è il seguente:',

		'Page Template could not be written to disk.' =>
		'Non è stato possibile scrivere il template sul disco.',

		'Please ensure handle contains at least one Latin-based character.' =>
		'Assicurati che l\'identificativo contenga almeno un carattere di famiglia latina.',

		'Unknown errors occurred while attempting to save.' =>
		'Si sono verificati degli errori durante il salvataggio.',

		'Check your activity log' =>
		'Controlla il registro delle attività',

		'One or more pages could not be deleted.' =>
		'Non &#232; stato possibile eliminare una o pi&#249; pagine.',

		'Click to expand or collapse a field.' =>
		'Clicca una volta per espandere o comprimere un campo.',

		'Double click to expand or collapse all fields.' =>
		'Clicca una volta per espandere o comprimere tutti i campi.',
		...
		'Visualizza le voci in questa sezione',

		'A Section with the name %s already exists' =>
		'Una sezione chiamata %s è già stata definita.',

		'A field with this handle already exists. All handle must be unique.' =>
		'Un campo con questo identificativo è già stato definito. Ricorda che gli identificativi devono essere univoci.',

		'There is already a field of type %s. There can only be one per section.' =>
		'Un campo del tipo %s &#232; gi&#224; stato definito. Pu&#242; esisterne solo uno per sezione.',

		'Utility updated at %s.' =>
		'Utility aggiornata %s',

		'View all Utilities' =>
		'Visualizza tutte le utility',

		'Utility created at %s.' =>
		'Utility creata %s',

		'Utility could not be written to disk.' =>
		'Non è stato possibile scrivere l\'utility sul disco.',

		'No username was entered.' =>
		'Non è stato immesso alcun nome utente.',

		'Password' =>
		false,

		'The supplied password was rejected.' =>
		'La password fornita è stata rifiutata.',

		'Retrieve password?' =>
		'Recupera la password',

		'The Section you are looking for, %s, could not be found.' =>
		'Non è stato possibile trovare la sezione %s.',
		...
		'Si è verificato un\'errore nel tentativo di filtrare le voci.',

		'Go to page …' =>
		'Vai a pagina …',

		'Fields must be added to this section before an entry can be created.' =>
		'Prima di creare una voce, la sezione deve contenere dei campi.',
		...
		'%s Consenti il login remoto tramite l\'URL',
		...
		'Nuova versione %1$s, richiede Symphony %2$s',

		'The Symphony configuration file, %s, is not writable. You will not be able to save changes to preferences.' =>
		'Il file di configurazione di Symphony, %s, non è scrivibile. Non sarà pertanto possibile salvare le impostazioni.',

		'Gateway' =>
		false,

		'An extension requires updating.' =>
		'Un\'estensione richiede un aggiornamento.',

		'View extensions' =>
		'Visualizza le estensioni',

		'An update has been found in your installation to upgrade Symphony to %s.' =>
		'È possibile aggiornare Symphony alla versione %s.',
		...
		'La versione di Symphony che stai utilizzato è la più recente, ma la cartella di installazione non è stata rimossa. Per motivi di sicurezza dovresti eliminarla.',

		'Remove installer?' =>
		'Rimuovi cartella di installazione',

		'An update script has been found in your installation.' =>
		'È stato trovato un aggiornamento per Symphony.',

		'Invalid timezone %s' =>
		'Fuso orario non valido %s',
		...
		'Si &#232; verificato un errore durante il tentativo di connessione al database. Assicurati che tutti i parametri siano corretti.',

		'Log out' =>
		'Esci',

		'E-mail address is already taken' =>
		'L\'indirizzo email fornito è già utilizzato',

		'Could not find Data Source %s.' =>
		'Non è stato possibile trovare la sorgente dati %s.',

		'If it was provided by an Extension, ensure that it is installed, and enabled.' =>
		'Se è stato fornito da un\'estensione, assicurarsi che essa sia stata correttamente installata e abilitata.',

		'Utility' =>
		false,

		'%1$s is not a supported encoding type. Please use %2$s or %3$s. You can also use %4$s for no encoding.' =>
		'%1$s non &#232; una codifica supportata. Usa %2$s, %3$s o anche %4$s se non vuoi alcuna codifica.',

		'%s accepts strings only; arrays are not allowed.' =>
		'%s accetta solo strinhe; gli array non sono permessi.',

		'The email address ‘%s’ is invalid.' =>
		'L\'indirizzo email ‘%s’ non è valido.',

		'The %1$s gateway does not support the use of %2$s' =>
		'Il gateway %1$s non supporta l\'uso di %2$s',

		'Could not find Email Gateway %s.' =>
		'Non è stato possibile trovare il gateway per email %s.',

		'Could not find Event %s.' =>
		'Non è stato possibile trovare l\'evento %s.',

		'The field ‘%s’, provided by the Extension ‘%s’, is currently in use.' =>
		'Il campo \'%s\' fornito dall\'estensione \'%s\' &#232; attualmente in uso.',

		'Please remove it from your sections prior to uninstalling or disabling.' =>
		'Assicurati che il campo venga eliminato da ogni sezione che ne fa uso prima di disabilitare o disinstallare l\'estensione.',

		'The Data Source ‘%s’, provided by the Extension ‘%s’, is currently in use.' =>
		'La sorgente dati \'%s\' fornita dall\'estensione \'%s\' &#232; attualmente in uso.',

		'Please remove it from your pages prior to uninstalling or disabling.' =>
		'Assicurati che la sorgente dati venga eliminata da ogni pagina che ne fa uso prima di disabilitare o disinstallare l\'estensione.',

		'The Event ‘%s’, provided by the Extension ‘%s’, is currently in use.' =>
		'L\'evento \'%s\' fornito dall\'estensione \'%s\' &#232; attualmente in uso.',

		'The Text Formatter ‘%s’, provided by the Extension ‘%s’, is currently in use.' =>
		'Il formattatore di testi \'%s\' fornito dall\'estensione \'%s\' &#232; attualmente in uso.',

		'Please remove it from your fields prior to uninstalling or disabling.' =>
		'Assicurati che il formattatore venga eliminato da ogni campo che ne fa uso prima di disabilitare o disinstallare l\'estensione.',

		'Missing default namespace definition.' =>
		'Namespace mancante.',

		'The %1$s file for the %2$s extension is not valid XML: %3$s' =>
		'Il file %1$s per l\'estensione %2$s contiene codice XML non valido: %3$s',

		'Could not find extension %s at location %s' =>
		'Non è stato possibile trovare l\'estensione %s in %s.',

		'New Field' =>
		'Nuovo campo',

		'%s Display in entries table' =>
		'%s Mostra il campo nell\'indice',

		'%s Display relationship in entries table' =>
		'%s Mostra l\'associazione nell\'indice',

		'Invalid element name. Must be valid %s.' =>
		'Il nome dell\'elemento dev\'essere di tipo %s.',

		'‘%s’ is a required field.' =>
		'Il campo ‘%s’ è obbligatorio.',

		'Data source output grouping is not supported by the %s field' =>
		'Il campo %s non permette di raggruppare l\'output proveniente dalle sorgenti dati',

		'Settings for field %s could not be found in table tbl_fields_%s.' =>
		'Le impostazioni per il campo %s non sono state trovate nella tabella associata.',

		'Could not find Field %1$s at %2$s.' =>
		'Non &#232; stato possibile trovare il campo %1$s in %2$s.',

		'Please login to view this page.' =>
		'Effettua l\'accesso per visualizzare questa pagina.',

		'Take me to the login page' =>
		'Portami alla pagina per effettuare l\'accesso',

		'Unable to remove - %s' =>
		'Non &#232; stato possibile effettuare la rimozione. - %s',

		'Enforced type `%1$s` for argument `$%2$s` does not match any known variable types.' =>
		'Il tipo `%1$s` richiesto per `$%2$s` non corrisponde ad alcun tipo noto.',

		'Argument `$%1$s` is not of type `%2$s`, given `%3$s`.' =>
		'Il tipo di `$%1$s`, `%3$s`, non corrisponde a `%2$s`.',
		...
		'Errore di underflow o di mancata corrispondenza fra le modalità.',

		'Unexpected control character found.' =>
		'È stato trovato un carattere di controllo non previsto.',

		'Syntax error, malformed JSON.' =>
		'Errore di sintassi JSON.',

		'Malformed UTF-8 characters, possibly incorrectly encoded.' =>
		'Possibile errore nella codifica di un carattere UTF-8.',

		'Unknown JSON error' =>
		'Errore JSON sconosciuto',

		'JSON not formatted correctly' =>
		'JSON non è formattato correttamente',

		'The selected language, %s, could not be found. Using default English dictionary instead.' =>
		'Il linguaggio selezionato, %s, non &#232; stato trovato. Verr&#224; utilizzato il dizionario Inglese.',

		'MySQL Error (%1$s): %2$s in query: %3$s' =>
		'Errore MySQL (%1$s): %2$s nella query %3$s',

		'Unable to find a Manager class for this resource.' =>
		'Non è stato possibile trovare una classe Manager per la risorsa.',
		...
		'Detach from Page' =>
		'Dissocia dalle pagine',

		'All' =>
		'Tutte',

		'Please check permissions on %s' =>
		'Verifica i permessi su %s.',

		'Could not find Text Formatter %s.' =>
		'Non &#232; stato possibile trovare il formattatore di testi %s.',
		...
		'La classe %s non è riuscita ad acquisire il lock, assicurati che %s esista e che sia scrivibile.',

		'Transformed XML is invalid.' =>
		'Il codice XML generato dalla trasformazione non è valido.',

		'Error creating field object with id %1$d, for filtering in data source %2$s. Check this field exists.' =>
		'Non &#232; stato possibile filtrare la sorgente dati %2$s tramite il campo %1$d. Assicurati che il campo esista.',

		'The section associated with the data source %s could not be found.' =>
		'La sezione associata alla sorgente dati %s non &#232; stata trovata.',

		'Sendmail (default)' =>
		'Sendmail (predefinito)',
		...
		'Disponibile se si usano valori dinamici',

		'Textarea' =>
		false,

		'Number of default rows' =>
		'Numero di righe di default',

		'‘%s’ contains invalid XML.' =>
		'‘%s’ contiene codice XML non valido',

		'Directory %s does not exist.' =>
		'La cartella %s non esiste.',

		'Destination folder is not writable.' =>
		'La cartella di destinazione non è scrivibile.',
		...
		'File chosen in ‘%s’ was only partially uploaded due to an error.' =>
		'Il file selezionato in ‘%s’  &#232; stato caricato solo parzialmente a causa di un errore.',
		...
		'Si &#232; verificato un errore durante il tentativo di caricamento del file %1$s nella cartella di destinazione %2$s.',
		...
		'Mostra il debug per %s',

		'Show line %d in debug view' =>
		'Mostra la linea n. %d nella modalità debug',
